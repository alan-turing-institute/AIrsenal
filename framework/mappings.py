...
alternative_team_names = {
    "ARS": ["1", "Arsenal"],
    "BOU": ["2", "Bournemouth"],
    "BHA": ["3", "Brighton and Hove Albion", "Brighton"],
    "BUR": ["4", "Burnley"],
    "CAR": ["5", "Cardiff", "Cardiff City"],
    "CHE": ["6", "Chelsea"],
    "CRY": ["7", "Crystal Palace"],
    "EVE": ["8", "Everton"],
    "FUL": ["9", "Fulham"],
    "HUD": ["10", "Huddersfield Town", "Huddersfield"],
    "LEI": ["11", "Leicester City", "Leicester"],
    "LIV": ["12", "Liverpool"],
    "MCI": ["13", "Manchester City", "Man City"],
    "MUN": ["14", "Manchester United", "Man Utd"],
    "NEW": ["15", "Newcastle United", "Newcastle"],
    "SOU": ["16", "Southampton"],
    "TOT": ["17", "Tottenham Hotspur", "Spurs"],
    "WAT": ["18", "Watford"],
    "WHU": ["19", "West Ham United", "West Ham"],
    "WOL": ["20", "Wolves", "Wolverhampton Wanderers"],
    "NOR": ["Norwich City"],
    "SUN": ["Sunderland"],
