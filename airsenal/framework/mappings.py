...
alternative_team_names = {
    ...
    "CHE": ["5", "Chelsea", "Chelsea FC"],
    "CRY": ["6", "Crystal Palace", "Crystal Palace FC"],
    "EVE": ["7", "Everton", "Everton FC"],
    "FUL": ["8", "Fulham", "Fulham FC"],
    "LEI": ["9", "Leicester City", "Leicester", "Leicester City FC"],
    "LEE": ["10", "Leeds", "Leeds United", "Leeds Utd"],
    "LIV": ["11", "Liverpool", "Liverpool FC"],
    "MCI": ["12", "Manchester City", "Man City", "Manchester City FC"],
    "MUN": [
        "13",
        "Manchester United",
        "Man Utd",
    ...
    "WBA": ["18", "West Bromwich Albion", "West Brom"],
