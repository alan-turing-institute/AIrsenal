...
def main():
    ...
    parser.add_argument("--gameweek_start", help="first gameweek to look at", type=int, default=1)
    parser.add_argument("--gameweek_end", help="last gameweek to look at", type=int, default=38)
    parser.add_argument("--weeks_ahead", help="how many weeks ahead to fill", type=int, default=3)
    parser.add_argument(
        "--season", help="season, in format e.g. '1819'", type=str, required=True
    )
    parser.add_argument(
        "--num_thread", help="number of threads to parallelise over", type=int, default=4
    )
    args = parser.parse_args()

    rerun_predictions(args.season,
                      args.gameweek_start,
                      args.gameweek_end,
                      args.weeks_ahead,
                      args.num_thread
